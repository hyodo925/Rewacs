...
if cfg.log.wandb:
    ...
    run = wandb.init(
        ...
        name=f"{start_time_log}_meta_critic_awac_finetuning_seed_{str(cfg.train.random_seed)}",
        dir=f"wandb/meta_critic_awac_finetuning/seed{str(cfg.train.random_seed)}",
    )
