...
class Model:
    ...
    actor_aggregator_enc_hdims = [64]
    critic_aggregator_enc_hdims = [64]

    actor_penultimate_norm = True
    critic_penultimate_norm = True
    meta_critic_penultimate_norm = True
...
class Log:
    wandb_project = "META_AWAC_training"
    # wandb_mode = "offline"
    wandb_mode = "online"
    wandb = True
    save_model = True
