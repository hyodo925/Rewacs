...
model = GraphSituationFlow(
    obs_dim=config.getint("Environment", "obs_dim"),
    h_dim=config.getint("Model", "h_dim"),
    n_flow_blocks=config.getint("Model", "n_flow_blocks"),
    n_flow_hidden_num=config.getint("Model", "n_flow_hidden_num"),
    threshold_type=config.get("Model", "threshold_type"),
)
...
epoch_num = config.getint("Train", "epoch_num")
...
grevnet_training(
    ...
    epoch_num=epoch_num,
    model_dir=path,
    model_save_freq=config.getint("Train", "model_save_freq"),
