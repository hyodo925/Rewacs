...
from algo.cql.critic import SocialCritic
from algo.cql.integrator import EmbeddedGaussianIntegrator
from algo.cql.trainer import CQL
from algo.cql.actor import SocialActorCQL
...
config_path = "./configs/cql_config.py"
...
if cfg.log.wandb:
    ...
    run = wandb.init(
        ...
        name=f"{start_time_log}_cql_training",
        dir=f"wandb/cql_training",
    )
