...
from algo.meta_critic.actor import SocialActorMetaCriticSAC
# from algo.meta_critic.trainer_hotplug import MetaCriticAWAC
from algo.meta_critic.trainer import MetaCriticSAC
...
config_path = "./configs/meta_critic_sac_with_flow_config.py"
...
if cfg.log.wandb:
    ...
    run = wandb.init(
        ...
        name=f"{start_time_log}_sac_meta_critic_finetuning/seed{str(cfg.train.random_seed)}",
        dir=f"wandb/sac_meta_critic_finetuning/seed{str(cfg.train.random_seed)}",
    )
...
actor = SocialActorMetaCriticSAC(
